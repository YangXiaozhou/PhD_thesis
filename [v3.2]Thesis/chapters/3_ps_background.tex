...
\mathcal{L} = \{1, \dots, L\} \,.
$$ 
An example power system is illustrated in Figure \ref{ch2:fig:ieee39}. This is a well-known IEEE standard test system representing the power system of New England area of the United States. This system has 39 buses connected by 46 transmission lines.   
