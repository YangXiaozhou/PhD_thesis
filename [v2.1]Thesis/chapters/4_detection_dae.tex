...
Additional line outage detection results are shown here. Fig. \ref{ch4:fig:line_0_detection_signal_breakdown} and Fig. \ref{ch4:fig:line_0_monitor_statistics} show the output signal breakdown and monitoring statistic progression under the outage-free scenario, i.e., zero line outage is simulated. 
\begin{figure}[!h]
\centering
...
\newpage
Fig. \ref{ch4:fig:line_6_detection_signal_breakdown} and Fig. \ref{ch4:fig:line_6_monitor_statistics} show the output signal breakdown and monitoring statistic progression for line 6 outage. The outage impact on the power grid is mild and short-lived, triggering insignificant increase in the monitoring statistic. 
\begin{figure}[!h]
\centering
